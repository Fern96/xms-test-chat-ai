      ...
      <div className="flex items-center justify-between px-4 pb-3 h-10">
        ...
        <div className="flex items-center gap-2">
          <Button
            ...
            title="上传文件"
          />
          <Tooltip title={useKb ? "已启用知识库" : "启用知识库参与回答"}>
            <div className="flex items-center gap-1 px-2 py-1 rounded-lg hover:bg-[var(--surface-hover)]">
              <BookOutlined className={useKb ? "text-blue-500" : "text-gray-500"} />
              <Switch size="small" checked={useKb} onChange={(v) => onToggleKb && onToggleKb(v)} />
            </div>
          </Tooltip>
          <Button
            type="text"
